...
`;var p=null,v=[];function f(s){s.store("lightbox",{show:{},items:{},touchStart:null,onTouchStart(e){if(!e.changedTouches){this.touchStart=null;return}this.touchStart=e.changedTouches[0]},onTouchEnd(e,t){if(!e.changedTouches||!this.touchStart)return;let{screenX:i,screenY:l}=this.touchStart,{screenX:a,screenY:n}=e.changedTouches[0];if(!i||!l||!a||!n)return;let r=i-a,o=l-n;Math.abs(r)<Math.abs(o)||(r>=100?this.next(t):r<=-100&&this.prev(t))},loadImage(e,t){let i=this.items[t].findIndex(({id:a})=>a===e.id);[e,this.nextItem(i,t),this.prevItem(i,t)].filter(Boolean).forEach(({id:a,url:n,loaded:r})=>{if(r)return;let o=new Image;o.onload=()=>{let h=this.items[t].findIndex(c=>c.id===a);this.items[t][h].loaded=!0,v.push(o)},o.src=n})},open(e,t){let i=t?this.items[e].find(l=>l[typeof t=="object"?"el":"url"]===t):this.items[e][0]||null;i&&(this.show[e]=i,this.loadImage(i,e))},prevItem(e,t){return e===0?this.items[t][this.items[t].length-1]:this.items[t][e-1]},nextItem(e,t){return e===this.items[t].length-1?this.items[t][0]:this.items[t][e+1]},navigate(e,t){let i=this.items[t].findIndex(a=>a.id===this.show[t].id),l=e==="prev"?this.prevItem(i,t):this.nextItem(i,t);this.show[t]=l,this.loadImage(l,t)},prev(e){this.navigate("prev",e)},next(e){this.navigate("next",e)}});function d(e,t,i=null,l=null,a=[]){if(Array.isArray(e)||(e=[e]),!document.querySelector(`#lightbox-${t}`)){let r=document.createElement("template");r.innerHTML=g;let o=r.content.children[0];o.id=`lightbox-${t}`,o.setAttribute("x-data",`{ group: '${t}' }`),document.body.appendChild(o),setTimeout(()=>{o.hasOwnProperty("_x_isShown")||s.initTree(o)},15)}s.store("lightbox").show[t]??=null,s.store("lightbox").items[t]??=[];let n=s.store("lightbox").items;e.forEach(r=>{let o=s.store("lightbox").items[t]?.findIndex(c=>c.id===i),h=y(r,t,i,l,a);o!==-1&&o!==void 0?n[t][o]={...n[t][o],...h}:(h.loaded=!h.lazy,n[t].push(h))})}s.magic("lightbox",()=>{function e(t,i=null){t=t.map(l=>(typeof l=="string"&&(l={url:l}),l.id=u(),l)),d(t,i||m())}return e.open=(t=null,i=null)=>{s.store("lightbox").open(i||m(),t)},e}),s.directive("lightbox",(e,{value:t,modifiers:i,expression:l},{effect:a,evaluateLater:n})=>{if(t==="group")return;if(!l){console.warn("Alpine warn: no url or config expression passed to x-lightbox",e);return}let r=n(l),o=u(),h=!1;a(()=>{r(c=>{s.nextTick(()=>{let x=C(e,c);d(c,x,o,e,i),h||(e.addEventListener("click",w=>{w.preventDefault(),s.store("lightbox").open(x,e)}),h=!0)})})})})}var u=()=>(Math.random()+1).toString(36).substring(2,15),C=(s,d)=>s.hasAttribute("x-lightbox:group")?s.getAttribute("x-lightbox:group"):d.group?String(d.group):m(),m=()=>(p??=u(),p),y=(s,d,e=null,t=null,i=[])=>(typeof s=="string"&&(s={url:s}),{type:"image",lazy:i.includes("lazy"),autoplay:!1,muted:!1,id:e,...s,el:t,group:d});var T=f;export{T as default};
